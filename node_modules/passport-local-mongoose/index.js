...
module.exports = function(schema, options) {
  ...
  options.errorMessages.MissingPasswordError = options.errorMessages.MissingPasswordError || 'No password entered';
  options.errorMessages.AttemptTooSoonError = options.errorMessages.AttemptTooSoonError || 'Account is locked. Please try again later';
  ...
  options.errorMessages.MissingUsernameError = options.errorMessages.MissingUsernameError|| 'No username entered';
  options.errorMessages.UserExistsError = options.errorMessages.UserExistsError|| 'Username is taken';
